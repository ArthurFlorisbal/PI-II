  ...
  <body>
      ...
      <?php
          ...
          $resultado_servico = mysqli_query($conexao, $result_servico);
		      ...
		      while($row_servico = mysqli_fetch_array($resultado_servico)){


          echo "<div class='card mx-5 mb-5 ml-5' style='width: 18rem;'>";

            echo "<p align='center'>EXIBIÇÃO DE FOTOS INDISPONÍVEL<br> NO MOMENTO</p>" . "<img src='" . '[EXIBIÇÃO DE FOTOS <br>INDISPONÍVEL NO MOMENTO]' . "' class='card-img-top' alt='...'>";

            echo "<div class='card-body'>";

              echo "<p class='card-text'>" . $row_servico['descricao'] . "</p><br><p>Valor: " . 
              $row_servico['pagamento'] . " R$.</p><br><p>Tempo estimado: " . $row_servico['tempoestimado'] . " minutos.</p><br>";
